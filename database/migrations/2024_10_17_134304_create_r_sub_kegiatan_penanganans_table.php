...
return new class extends Migration
{
    ...
    {
        Schema::create('r_sub_kegiatan_penanganans', function (Blueprint $table) {
            $table->id();

            $table->biginteger('r_kegiatan_penanganan_id')->nullable();
    ...
    {
        Schema::dropIfExists('r_sub_kegiatan_penanganans');
    }
};
