                        ...
                        <table class="table table-bordered table-striped table-responsive" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- Foto-foto -->
                                    <td><img src="/storage/{{ $item->foto_1 }}" alt="Foto 1" width="100"></td>
                                    <td><img src="/storage/{{ $item->foto_2 }}" alt="Foto 2" width="100"></td>
                                    <td><img src="/storage/{{ $item->foto_3 }}" alt="Foto 3" width="100"></td>
                                    <td><img src="/storage/{{ $item->foto_4 }}" alt="Foto 4" width="100"></td>
                                    <td><img src="/storage/{{ $item->foto_5 }}" alt="Foto 5" width="100"></td>
