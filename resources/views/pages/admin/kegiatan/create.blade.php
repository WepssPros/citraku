    ...
    <div class="col-lg-12">
        <div class="card card-default">
            ...
            <div class="card-body p-0">
                <form action="{{ route('dashboard.kegiatan.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="bs-stepper-header" role="tablist">
                            <div class="step" data-target="#article-part">
                                <button type="button" class="step-trigger" role="tab" aria-controls="article-part"
                                    ...
                                    <span class="bs-stepper-label">Masukkan Informasi Kegiatan</span>
                                </button>
                            </div>
                            <div class="line"></div>
                            ...
                            <div id="article-part" class="content" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="program_id" id="program_id" class="form-control select2" required>
                                        ...
                                        <option value="{{ $program->id }}">{{$program->header}}/{{ $program->kode }}/
                                            {{$program->program}}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode" id="kode" class="form-control"
                                        placeholder="Masukkan Kode Kegiatan" required>
                                </div>
                                <div class="form-group">
