    ...
    <div class="col-lg-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Edit Sub Kegiatan Program </h3>
            </div>
            <div class="card-body p-0">
                <form action="{{ route('dashboard.subkegiatan.update', $subKegiatan->id) }}" method="POST"
                        ...
                        <div class="bs-stepper-header" role="tablist">
                            <div class="step" data-target="#article-part">
                                <button type="button" class="step-trigger" role="tab" aria-controls="article-part"
                                    ...
                                    <span class="bs-stepper-label">Edit Informasi Sub Kegiatan</span>
                                </button>
                            </div>
                            <div class="line"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kegiatan_id" id="kegiatan_id" class="form-control select2" required>
                                        ...
                                        <option value="{{ $item->id }}"
                                            {{ $subKegiatan->kegiatan_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->program->header }}/{{ $item->program->kode }}/{{ $item->kode }}/{{ $item->kegiatan }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
